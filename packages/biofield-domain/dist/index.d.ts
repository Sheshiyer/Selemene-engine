export declare const BIOFIELD_ENGINE_ID = "biofield-capture";
export declare const BIOFIELD_SESSION_STATUSES: readonly ["active", "closed", "abandoned"];
export declare const BIOFIELD_CAPTURE_STATES: readonly ["requested", "uploaded", "analyzed", "persisted", "rejected", "reprocessed"];
