...
impl StandalonePanchangaCalculator {
    ...
    pub fn calculate_tithi(&self, solar_longitude: f64, lunar_longitude: f64, jd: f64) -> Tithi {
        ...
        Tithi {
            ...
            start_time: Some(DateTime::from_timestamp((jd - 2440588.0) * 86400.0, 0).unwrap_or_default()),
            end_time: Some(DateTime::from_timestamp((jd - 2440588.0) * 86400.0, 0).unwrap_or_default()),
        }
    }
