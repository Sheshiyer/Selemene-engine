# Legacy Todo Archive — 2026-05 Drift Remediation Plan

**Archived from:** tasks/todo.md (as of 2026-05-08, 203 lines)  
**Archived on:** 2026-07-05  
**Reason:** Full platform shift — noesis-web + biofield-web retired to Sankalpa; witness agents largely retired; Supabase retired; platform now Cloudflare Workers + R2 + D1 + Vectorize + Railway Postgres + witness-pipeline. All P1-P4 items below are historical; no active GH issues/PRs for most.
