...
export interface AdminLivingReadingInvitation {
  id: string;
  reading_id: string;
...
export interface AdminLivingReadingInvitationsResponse {
  items: AdminLivingReadingInvitation[];
}

export interface CreateLivingReadingInvitationResponse {
  invitation: AdminLivingReadingInvitation;
  token: string;
  recipient_path: string;
}

export interface LivingReadingInvitationResolution {
  reading_id: string;
  stable_reading_id: string;
  title: string;
  summary: string | null;
  ...
  language_tag: string;
  editorial_state: string | null;
  subjects: Array<{ canonical_name: string; role: string }>;
  relationship_label: string | null;
  artifact: {
    availability: string;
    media_type: string | null;
