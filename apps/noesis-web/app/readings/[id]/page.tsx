...
const s = {
  ...
  heading: { fontFamily: "var(--font-display)", fontSize: "1.4rem", fontWeight: 800, color: "var(--text)", margin: 0 },
  meta: { display: "flex", gap: "1rem", fontSize: "0.8rem", color: "var(--text-muted)", fontFamily: "var(--font-mono)" },
  tabBar: { display: "flex", gap: "0.375rem", overflowX: "auto" as const, padding: "0.5rem 0", borderBottom: "1px solid var(--line)" },
  tab: {
    padding: "0.4rem 0.875rem", fontSize: "0.78rem", fontWeight: 500, color: "var(--text-muted)",
    borderRadius: "var(--radius)", whiteSpace: "nowrap" as const, cursor: "pointer",
    border: "1px solid transparent", background: "transparent", transition: "all 0.15s", fontFamily: "var(--font-body)",
  },
  tabActive: { background: "var(--gold-soft)", color: "var(--gold)", border: "1px solid var(--gold)" },
  tabHasData: { color: "var(--text)", border: "1px solid var(--line)" },
