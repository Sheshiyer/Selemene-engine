...
#[openapi(
    ...
    components(
        schemas(
            ...
            handlers::admin::AdminSelemeneSkill,
            handlers::admin::AdminSelemeneReportMode,
            handlers::admin::AdminSelemeneAutoresearch,
            handlers::admin::AdminSelemeneVectorize,
            handlers::admin::AdminSelemeneMcp,
