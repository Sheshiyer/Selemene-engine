...
use super::{Gender, NameSuggestion, NamingRequest, NamingResponse, NamkaranInfo};
...
pub fn generate_names(request: &NamingRequest) -> NamingResponse {
    ...
    for syllable in &syllables {
        let names = get_names_for_syllable(
            syllable,
            request.gender,
            request.preferred_origin.as_deref(),
        );
        for name in names
            .into_iter()
            .take(request.count / syllables.len().max(1) + 1)
        {
...
fn get_names_for_syllable(
    ...
    all_names
        ...
        .filter(|n| {
            origin
                .map(|o| n.origin.eq_ignore_ascii_case(o))
                .unwrap_or(true)
        })
        .collect()
}
...
fn get_sample_names() -> Vec<NameSuggestion> {
    vec![
        ...
        NameSuggestion {
            name: "Chudamani".to_string(),
            syllable: "Chu".to_string(),
            meaning: "Crest jewel".to_string(),
            gender: Gender::Female,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Chudamani"),
            popularity: 60,
        },
        NameSuggestion {
            name: "Chetan".to_string(),
            syllable: "Che".to_string(),
            meaning: "Consciousness".to_string(),
            gender: Gender::Male,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Chetan"),
            popularity: 75,
        },
        NameSuggestion {
            name: "Lakshmi".to_string(),
            syllable: "La".to_string(),
            meaning: "Goddess of wealth".to_string(),
            gender: Gender::Female,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Lakshmi"),
            popularity: 90,
        },
        NameSuggestion {
            name: "Lakshmana".to_string(),
            syllable: "La".to_string(),
            meaning: "Marked with auspicious signs".to_string(),
            gender: Gender::Male,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Lakshmana"),
            popularity: 70,
        },
        // Rohini - O, Va/Wa, Vi/Wi, Vu/Wu
        NameSuggestion {
            name: "Om".to_string(),
            syllable: "O".to_string(),
            meaning: "Sacred sound".to_string(),
            gender: Gender::Male,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Om"),
            popularity: 85,
        },
        NameSuggestion {
            name: "Varun".to_string(),
            syllable: "Va".to_string(),
            meaning: "God of water".to_string(),
            gender: Gender::Male,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Varun"),
            popularity: 80,
        },
        NameSuggestion {
            name: "Vidya".to_string(),
            syllable: "Vi".to_string(),
            meaning: "Knowledge".to_string(),
            gender: Gender::Female,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Vidya"),
            popularity: 85,
        },
        NameSuggestion {
            name: "Vivek".to_string(),
            syllable: "Vi".to_string(),
            meaning: "Wisdom".to_string(),
            gender: Gender::Male,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Vivek"),
            popularity: 80,
        },
        // Pushya - Hu, He, Ho, Da
        NameSuggestion {
            name: "Harsh".to_string(),
            syllable: "Ha".to_string(),
            meaning: "Joy".to_string(),
            gender: Gender::Male,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Harsh"),
            popularity: 75,
        },
        NameSuggestion {
            name: "Daksha".to_string(),
            syllable: "Da".to_string(),
            meaning: "Able, skilled".to_string(),
            gender: Gender::Male,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Daksha"),
            popularity: 65,
        },
        // Magha - Ma, Mi, Mu, Me
        NameSuggestion {
            name: "Madhav".to_string(),
            syllable: "Ma".to_string(),
            meaning: "Krishna".to_string(),
            gender: Gender::Male,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Madhav"),
            popularity: 80,
        },
        NameSuggestion {
            name: "Meera".to_string(),
            syllable: "Me".to_string(),
            meaning: "Ocean, limit".to_string(),
            gender: Gender::Female,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Meera"),
            popularity: 85,
        },
        // Revati - De, Do, Cha, Chi
        NameSuggestion {
            name: "Dev".to_string(),
            syllable: "De".to_string(),
            meaning: "God".to_string(),
            gender: Gender::Male,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Dev"),
            popularity: 85,
        },
        NameSuggestion {
            name: "Chitra".to_string(),
            syllable: "Chi".to_string(),
            meaning: "Picture".to_string(),
            gender: Gender::Female,
            origin: "Sanskrit".to_string(),
            numerology: calculate_numerology("Chitra"),
            popularity: 70,
        },
    ]
}
