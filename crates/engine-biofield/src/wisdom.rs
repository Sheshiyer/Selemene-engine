...
fn build_metric_interpretations() -> HashMap<String, MetricInterpretation> {
    ...
    map.insert(
        ...
        MetricInterpretation {
            ...
            Healthy biofields exhibit fractal patterns similar to those found in nature."
                .to_string(),
            low_meaning: "Low fractal dimension (< 1.3) may indicate depleted energy or \
            simplified patterns, potentially associated with fatigue or illness."
                .to_string(),
            optimal_meaning: "Optimal fractal dimension (1.4-1.7) suggests complex, \
            healthy energy patterns with good vitality and resilience."
                .to_string(),
            high_meaning: "Very high fractal dimension (> 1.8) may indicate chaotic or \
            unstable patterns, potentially associated with stress or overstimulation."
                .to_string(),
    ...
    map.insert(
        ...
        MetricInterpretation {
            ...
            Measures the information content and variability of the energy field."
                .to_string(),
            low_meaning: "Low entropy (< 0.3) indicates uniform patterns, potentially \
            suggesting stagnation or blocked energy flow."
                .to_string(),
            optimal_meaning: "Balanced entropy (0.4-0.7) suggests healthy variety in \
            energy expression with organized complexity."
                .to_string(),
    ...
    map.insert(
        ...
        MetricInterpretation {
            ...
            indicates equal energy flow on both sides of the body."
                .to_string(),
            ...
            distribution and integrated function."
                .to_string(),
